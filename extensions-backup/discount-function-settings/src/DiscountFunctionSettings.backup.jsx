// With 2025-10RC, we need to update the import approach
// The extension will be scaffolded with Preact by default when using POLARIS_UNIFIED=true
// For now, keeping React imports but components will use web components syntax
import {
  reactExtension,
  useApi,
  FunctionSettings,
            ...
            <BlockStack gap="large">
              <Box>
                <InlineStack gap="base" blockAlignment="center" inlineAlignment="spaceBetween">
                  ...
                  <InlineStack gap="base" wrap={false}>
                    <Button 
                  ...
                  {/* Right side - default type selector and clear all */}
                  <InlineStack gap="large" blockAlignment="center">
                    <InlineStack gap="base" blockAlignment="center">
...
You can also use comma: SKU123,10.00`}
          ...
          <Section>
            <BlockStack gap="base">
              <Box>
                <InlineStack blockAlignment="center" wrap={false}>
                ...
                <Box border="base" borderRadius="base">
                  <BlockStack gap="none">
                    {productEntries.map(([key, product], index) => (
                      ...
                      >
                        <InlineStack gap="base" blockAlignment="start" wrap={false}>
                          ...
                          >
                            {product.image ? (
                              ...
                              <Icon name="ProductsMajor" size="large" />
                            )}
                          </Box>
                          ...
                          <Box minInlineSize="fill">
                            <BlockStack gap="tight">
                              ...
                              <Text variant="bodySm" fontWeight="semiBold" truncate={1}>
                                {(() => {
                              ...
                              {/* Controls row */}
                              <InlineStack gap="tight" blockAlignment="center" wrap={false} inlineAlignment="start">
                                {/* Price */}
                                ...
                                {/* Result */}
                                <Box minInlineSize={70} inlineAlignment="center">
