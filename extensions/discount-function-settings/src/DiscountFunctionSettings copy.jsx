...
// Access shopify from global window object
...
function App() {
  // Access the global shopify object with proper typing
  ...
  async function saveMetafieldChanges(event) {
    ...
    try {
      ...
      if (event && event.waitUntil) {
        await event.waitUntil(applyMetafieldChange(metafield));
      } else {
        await applyMetafieldChange(metafield);
      }
  ...
  if (loading) {
    return (
      <s-card>
        <s-box padding="large">
          <s-stack gap="base" align="center" distribution="center">
            <s-spinner />
    ...
    <s-box padding="base">
      <s-form onsubmit={saveMetafieldChanges} onreset={resetForm}>
        <s-stack gap="large">
          ...
          <s-card>
            <s-box padding="large">
              <s-stack gap="base" align="center" distribution="space-between">
                <s-stack gap="small-100">
