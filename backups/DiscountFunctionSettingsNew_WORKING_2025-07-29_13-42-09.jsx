...
✓ Copy directly from Excel, Google Sheets, or CSV files`}
        ...
        {products.length === 0 ? (
          ...
          <s-stack gap="base">
            {/* Table Header */}
            <s-box padding="small-400" background="strong" borderRadius="base">
              <s-grid gridTemplateColumns="48px 1fr 65px 55px 4px 70px 4px 65px 36px">
